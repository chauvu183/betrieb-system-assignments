...
public class OperatingSystem {
	...
	public synchronized int read(int pid, int virtAdr) {
		...
		int offset;
		// Reale Adresse des Datenworts
		int realAddress;
		// Aktuelles Prozessobjekt
		Process proc;
		// Eintrag für die zu schreibende Seite
		PageTableEntry pte;
		...
		// Seite in Seitentabelle vorhanden? - Nein: Zugriffsfehler (Adresse ungültig)
		if(pte == null) {
			return -1;
		}
	...
	private int getVirtualPageNum(int virtAdr) {
		//TODO
		//virtuelle Adresse muss um 8 Stellen nach rechts geschoben werden
